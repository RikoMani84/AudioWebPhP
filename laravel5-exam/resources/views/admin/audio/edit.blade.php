        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body" style="font-size:  1.25rem;">
                    <form action="/audio-update/{{ $audio->id }}" method="POST" enctype="multipart/form-data">

                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Title:</label>
                            <input type="text" name="title" class="form-control" value="{{$audio->title}}" id="recipient-name">
                            @error('title')
